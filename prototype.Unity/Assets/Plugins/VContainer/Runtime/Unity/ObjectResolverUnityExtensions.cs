...
namespace VContainer.Unity
{
    public static class ObjectResolverUnityExtensions
    {
        ...
        private static GameObject Instantiate(this LifetimeScope scope, GameObject prefab, Vector3 position,
            Quaternion rotation)
        {
        ...
        public static GameObject Instantiate(this IObjectResolver resolver, GameObject prefab, Transform parent,
            bool worldPositionStays = false)
        {
            var wasActive = prefab.activeSelf;
            prefab.SetActive(false);
        ...
        public static GameObject Instantiate(
            ...
            Quaternion rotation)
        {
            if (resolver.ApplicationOrigin is LifetimeScope scope) return scope.Instantiate(prefab, position, rotation);
